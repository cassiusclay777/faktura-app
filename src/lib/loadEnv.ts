 ...
 * Pro API používají stejné proměnné i **Gemini** (`GEMINI_API_KEY`, `GEMINI_MODEL`) a **DeepSeek** (`DEEPSEEK_API_KEY`, …). Volitelně **TAVILY_API_KEY** pro web u korekce DeepSeek.
 *
